...
public class PoiModel
{
    ...
    [MaxLength(100)] public string PoiType { get; init; } = string.Empty;
    [MaxLength(100)] public string PoiSubtype { get; init; } = string.Empty;
    public List<double>? Location { get; init; }
    public List<List<double>>? Boundary { get; init; }
    public bool IsPromoted { get; init; }
    [MaxLength(100)] public string? HexagonId { get; init; }
...
{
    [Key] [MaxLength(100)] public string City { get; init; } = string.Empty;
    [MaxLength(100)] public string Country { get; init; } = string.Empty;
...
public class UserHexagonProgress
{
    ...
    [MaxLength(100)] public string HexagonId { get; init; } = string.Empty;
